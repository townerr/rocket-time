...
CREATE TABLE "Balance" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "vacation" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "Entry" ADD CONSTRAINT "Entry_timesheetId_fkey" FOREIGN KEY ("timesheetId") REFERENCES "Timesheet"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
