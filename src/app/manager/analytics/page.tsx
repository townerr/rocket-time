...
const DEFAULT_EMPLOYEE_DATA = [{ name: "No data", hours: 0 }];

const DEFAULT_PROJECT_DATA = [{ name: "No data", value: 1 }];
...
export default function AnalyticsPage() {
  ...
  const isLoading =
    ...
    projectDistributionLoading ||
    timesheetStatusLoading;
  const hasError =
    employeeHoursError || projectDistributionError || timesheetStatusError;
  ...
  const displayedEmployeeData = hasEmployeeData
    ? employeeHoursData
    : DEFAULT_EMPLOYEE_DATA;
  const displayedProjectData = hasProjectData
    ? projectDistributionData
    : DEFAULT_PROJECT_DATA;
  const displayedStatusData = hasStatusData
    ? timesheetStatusData
    : DEFAULT_STATUS_DATA;
          ...
          {hasError && (
            <Alert variant="destructive" className="mb-6">
              ...
              <div>
                ...
                <AlertDescription>
                  There was an error loading the analytics data. Please try
                  again later.
                </AlertDescription>
              </div>
            </Alert>
            ...
            <Tabs defaultValue="hours" className="mt-6">
              ...
              <TabsContent value="hours" className="space-y-4">
                ...
                <div className="text-center text-sm text-muted-foreground">
                  Total users with logged hours:{" "}
                  {hasEmployeeData ? employeeHoursData?.length || 0 : 0}
                </div>
              </TabsContent>
              ...
              <TabsContent value="projects" className="space-y-4">
                ...
                <div className="text-center text-sm text-muted-foreground">
                  Total projects:{" "}
                  {hasProjectData ? projectDistributionData?.length || 0 : 0}
                </div>
              </TabsContent>
