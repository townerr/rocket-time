 ...
 */
export function getEntriesForDate(entries: EnhancedEntry[] | undefined, date: Date): EnhancedEntry[] {
  if (!entries) return [];
 ...
 */
export function getDayTotalHours(entries: EnhancedEntry[] | undefined, date: Date): number {
 ...
 */
export function getWeekTotalHours(entries: EnhancedEntry[] | undefined): number {
  if (!entries) return 0;
